...
class CollocationComp(om.ImplicitComponent):
    """
    ...
    **kwargs : dict
    ...
    def apply_nonlinear(self, inputs, outputs, residuals):
        """
        Compute residuals of the collocation defects.
        """
        state_options = self.options['state_options']
        dt_dstau = inputs['dt_dstau']
        ...
        for state_name in state_options:
            ...
            f_approx = inputs[var_names['f_approx']]
            f_computed = inputs[var_names['f_computed']]
            defect_actual = outputs[var_names['defect']]

            # Defining the residual to be driven to zero
            residuals[var_names['defect']] = ((f_approx - f_computed).T * dt_dstau).T - defect_actual
